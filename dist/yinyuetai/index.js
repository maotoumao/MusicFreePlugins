...
function formatMusicItem(item) {
    ...
    return {
        id: item.id,
        title: item.title,
        artist: (item === null || item === void 0 ? void 0 : item.allArtistNames) || ((_b = (_a = item.artists) === null || _a === void 0 ? void 0 : _a.map) === null || _b === void 0 ? void 0 : _b.call(_a, (s) => s.name).join(", ")) || ((_c = item.user) === null || _c === void 0 ? void 0 : _c.niceName),
...
async function getArtistWorks(artistItem, page, type) {
    if (type === 'music') {
        let sinceId = (page === 1 || artistItem.id !== lastArtistId) ? lastArtistId : 0;
        const medias = (await axios_1.default.get("https://video-api.yinyuetai.com/video/listByArtist", {
            "params": {
        ...
        lastArtistId = medias[medias.length - 1].id;
        return {
...
module.exports = {
    platform: "音悦台",
    version: "0.0.0",
    supportedSearchType: ["music", "artist",],
